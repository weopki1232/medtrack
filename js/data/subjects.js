const DEFAULT_SUBJECTS = [
  { id:'alevel_bio', name:'A-Level Biology', shortName:'Biology', color:'#10b981', icon:'🧬', glyph:'❋', targetHours:120, priority:'high', examDate:'2027-03-13',
  ...
  { id:'alevel_chem', name:'A-Level Chemistry', shortName:'Chemistry', color:'#f59e0b', icon:'⚗️', glyph:'⚗︎', targetHours:150, priority:'critical', examDate:'2027-03-14',
  ...
  { id:'alevel_phys', name:'A-Level Physics', shortName:'Physics', color:'#6366f1', icon:'⚡', glyph:'⚡︎', targetHours:140, priority:'critical', examDate:'2027-03-13',
  ...
  { id:'alevel_math1', name:'A-Level Math 1', shortName:'Math 1', color:'#8b5cf6', icon:'📐', glyph:'∫', targetHours:150, priority:'critical', examDate:'2027-03-14',
  ...
  { id:'alevel_eng', name:'A-Level English', shortName:'English', color:'#06b6d4', icon:'📖', glyph:'¶', targetHours:80, priority:'medium', examDate:'2027-03-14',
  ...
  { id:'alevel_thai', name:'A-Level Thai', shortName:'Thai', color:'#ec4899', icon:'🇹🇭', glyph:'ก', targetHours:60, priority:'medium', examDate:'2027-03-13',
  ...
  { id:'alevel_social', name:'A-Level Social Studies', shortName:'Social', color:'#f97316', icon:'🌏', glyph:'♁', targetHours:60, priority:'medium', examDate:'2027-03-13',
  ...
  { id:'tgat1', name:'TGAT1 - English Communication', shortName:'TGAT1', color:'#14b8a6', icon:'💬', glyph:'❝', targetHours:40, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tgat2', name:'TGAT2 - Critical Thinking', shortName:'TGAT2', color:'#a855f7', icon:'🧠', glyph:'∴', targetHours:30, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tpat1', name:'TPAT1 - Medical Aptitude', shortName:'TPAT1', color:'#ef4444', icon:'🩺', glyph:'✚', targetHours:80, priority:'critical', examDate:'2027-02-13',
  ...
  { id:'tgat3', name:'TGAT3 - Future Workforce Competencies', shortName:'TGAT3', color:'#84cc16', icon:'💼', glyph:'◇', targetHours:30, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tpat2', name:'TPAT2 - Arts Aptitude', shortName:'TPAT2', color:'#f43f5e', icon:'🎨', glyph:'◐', targetHours:40, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tpat3', name:'TPAT3 - Science, Technology & Engineering', shortName:'TPAT3', color:'#0ea5e9', icon:'🔧', glyph:'⚙︎', targetHours:60, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tpat4', name:'TPAT4 - Architecture Aptitude', shortName:'TPAT4', color:'#d97706', icon:'🏛️', glyph:'⌂', targetHours:40, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'tpat5', name:'TPAT5 - Teaching Aptitude', shortName:'TPAT5', color:'#22c55e', icon:'🍎', glyph:'✎', targetHours:40, priority:'medium', examDate:'2027-01-30',
  ...
  { id:'alevel_math2', name:'A-Level Math 2', shortName:'Math 2', color:'#c084fc', icon:'📏', glyph:'∑', targetHours:80, priority:'medium', examDate:'2027-03-15',
  ...
  { id:'alevel_sci', name:'A-Level Applied Science', shortName:'Applied Sci', color:'#34d399', icon:'🔬', glyph:'✱', targetHours:70, priority:'medium', examDate:'2027-03-15',
  ...
  { id:'alevel_fre', name:'A-Level French', shortName:'French', color:'#3b82f6', icon:'🇫🇷', glyph:'Ç', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_ger', name:'A-Level German', shortName:'German', color:'#71717a', icon:'🇩🇪', glyph:'ß', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_jap', name:'A-Level Japanese', shortName:'Japanese', color:'#fb7185', icon:'🇯🇵', glyph:'あ', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_kor', name:'A-Level Korean', shortName:'Korean', color:'#60a5fa', icon:'🇰🇷', glyph:'한', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_chi', name:'A-Level Chinese', shortName:'Chinese', color:'#dc2626', icon:'🇨🇳', glyph:'中', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_bali', name:'A-Level Pali', shortName:'Pali', color:'#a16207', icon:'📿', glyph:'☸︎', targetHours:60, priority:'low', examDate:'2027-03-15',
  ...
  { id:'alevel_spa', name:'A-Level Spanish', shortName:'Spanish', color:'#fbbf24', icon:'🇪🇸', glyph:'Ñ', targetHours:60, priority:'low', examDate:'2027-03-15',
...
const TRACK_PRESETS = [
  { id:'medicine',     icon:'🩺', glyph:'✚', subjects:['tpat1','alevel_bio','alevel_chem','alevel_phys','alevel_math1','alevel_eng','alevel_thai','alevel_social','tgat1','tgat2','tgat3'] },
  { id:'engineering',  icon:'🔧', glyph:'⚙︎', subjects:['tpat3','alevel_math1','alevel_phys','alevel_chem','alevel_eng','tgat1','tgat2','tgat3'] },
  { id:'science',      icon:'🔬', glyph:'✱', subjects:['alevel_math1','alevel_phys','alevel_chem','alevel_bio','alevel_eng','tgat1','tgat2','tgat3'] },
  { id:'arts',         icon:'🎨', glyph:'◐', subjects:['tpat2','alevel_thai','alevel_social','alevel_eng','tgat1','tgat2','tgat3'] },
  { id:'architecture', icon:'🏛️', glyph:'⌂', subjects:['tpat4','alevel_math1','alevel_phys','alevel_eng','tgat1','tgat2','tgat3'] },
  { id:'education',    icon:'🍎', glyph:'✎', subjects:['tpat5','alevel_thai','alevel_eng','alevel_social','alevel_math2','tgat1','tgat2','tgat3'] },
  { id:'humanities',   icon:'🌏', glyph:'♁', subjects:['alevel_thai','alevel_social','alevel_eng','alevel_math2','tgat1','tgat2','tgat3'] },
];
